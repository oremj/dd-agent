...
$DOWNLOADER "$DD_HOME/requirements.txt" "$BASE_GITHUB_URL/source-requirements.txt"
...
$DOWNLOADER "$DD_HOME/optional-requirements.txt" "$BASE_GITHUB_URL/source-optional-requirements.txt"
OPTIONAL_FAILED="0"
...
done < "$DD_HOME/optional-requirements.txt"
